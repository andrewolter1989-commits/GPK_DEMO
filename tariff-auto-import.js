(function(){
  ...
  function analyzeSheet(sheetName,rows){
    ...
    if(efCustom)blocks.push(efCustom);
  ...
  function renderZoneSheet(block,country){
    ...
    if(tariffZoneMode){
      ...
      }).join("")||`<tr><td colspan="4" class="empty-state">Keine Tarifzonen für diese Auswahl.</td></tr>`;
